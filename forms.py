    ...
    def validate_genres(form, field):
        ...
        for value in field.data:
            if value not in genres_values:
                raise ValidationError('Only available genres can be selected')
...
class ArtistForm(FlaskForm):
    ...
    phone = StringField(
        # DONE 
        'phone', validators=[DataRequired(), Regexp(r'\d{3}-\d{3}-\d{4}', message='Please provide US phone number in format 123-456-7890')]
    )
    image_link = StringField(
